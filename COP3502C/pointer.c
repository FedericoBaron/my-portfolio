...
// ====================
// Introduction to pointer arithmetic. (There isn't actually any dynamic memory
// allocation in this program.)
...
int main(void)
{
	...
	// Exercise: So, if you want to print all the integers in that array, how
	// would you do it?
